Ext.define('Ext.ux.field.TimePickerField', {
    ...
    */
    ...
    onRender: function () {
        ...
        spinnerWrapDom = Ext.dom.Query.select('td', this.getEl().dom)[0]; // 4.0 ->4.1 div->td
...
Ext.define('Ext.ux.field.DateTimePicker', {
    ...
    todayText: '现在',
    timeLabel: '时间',
    requires: ['Ext.ux.field.TimePickerField'],
    initComponent: function () {
    ...
    onRender: function (container, position) {
        if (!this.timefield) {
            this.timefield = Ext.create('Ext.ux.field.TimePickerField', {
...
Ext.define('Ext.ux.field.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    requires: ['Ext.ux.field.DateTimePicker'],
    initComponent: function () {
    ...
    createPicker: function () {
        ...
        return Ext.create('Ext.ux.field.DateTimePicker', {
            ownerCt: me.ownerCt,
