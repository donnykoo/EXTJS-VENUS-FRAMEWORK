 ...
 */
Ext.define('Ext.ux.field.NumericField', 
{
    extend: 'Ext.form.field.Number',//Extending the NumberField
    alias: 'widget.ux.field.NumericField',//Defining the xtype,
    currencySymbol: null,
    ...
    setValue: function(value){
        Ext.ux.field.NumericField.superclass.setValue.call(this, value != null ? value.toString().replace('.', this.decimalSeparator) : value);
    ...
    parseValue: function(value){
        ...
        return Ext.ux.field.NumericField.superclass.parseValue.call(this, this.removeFormat(value));
    },
    /**
    ...
    getErrors: function(value){
        return Ext.ux.field.NumericField.superclass.getErrors.call(this, this.removeFormat(value));
    },
    hasFormat: function(){
