Ext.require([
	'Module.pos.pickOutOrder.store.PickLines',
...
Ext.define('Module.pos.pickOutOrder.view.CreateWindow', {
	extend: 'Ext.Window',
	alias: 'widget.pickOutOrderCreateWindow',
	height: 540,
	width: 800,
	constrain: true,
	modal: true,
	...
	apiPath: Ext.String.format('{0}/api/PickOutOrdersApi', "/" === basket.contextPath ? "" : basket.contextPath),
	...
	initComponent: function() {
		...
		var store = me.store = Ext.create('Module.pos.pickOutOrder.store.PickLines', { 
			listeners: {
		...
		var grid = me.grid = Ext.create('Ext.grid.Panel', {
			...
			columns: [
				...
				{ 
					text: '应发数量', dataIndex: 'Quantity', width: 100,
	...
	onAddLineClick: function(btn, event, eOpts){
		var me = this,
			store = this.getStore();
		if(store){
			var model = Ext.create('Module.pos.pickOutOrder.model.PickLine', {
				SKU: '',
				Name: '',
				UOM: '',
				Quantity: 0.0
	...
	onShipClicked: function (button, event) {
	    ...
	    if (!me.createShipWindow) {
	        me.createShipWindow = Ext.widget('pickOutOrderShipWindow');
	    }
	...
	refresh: function(data){
		...
		try{
			...
			var record = Ext.create('Module.pos.pickOutOrder.model.PickOutOrder', data);
...
Ext.define('Module.pos.pickOutOrder.view.shipWindow', {
    extend: 'Ext.Window',
    alias: 'widget.pickOutOrderShipWindow',
    height: 540,
    width: 800,
    constrain: true,
    modal: true,
