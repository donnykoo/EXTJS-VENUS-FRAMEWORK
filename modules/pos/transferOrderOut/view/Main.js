 ...
 */
Ext.define('Module.pos.transferOrderOut.view.Main', {
    extend: 'Ext.ux.view.SearchPanel',
    alias: 'widget.transferOrderOutMainView',
    ...
    initComponent: function() {
        ...
        Ext.apply(me, {
            ...
            store: Ext.data.StoreManager.lookup('Module.pos.transferOrderOut.store.TransferOrderOuts'),
            columns: [
				{xtype: 'rownumberer'},
	...
	getCreateWindow: function(){
		var me = this;
		if(!me.createWindow){
			me.createWindow = Ext.widget('transferOrderOutCreateWindow');
		}
