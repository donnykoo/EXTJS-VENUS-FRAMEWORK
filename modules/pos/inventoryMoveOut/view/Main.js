...
//InventoryMoveOutLineForm  Grid新建Form
Ext.define("InventoryMoveOutLineForm", {
    extend: "Ext.form.Panel",
    alias: ['widget.inventoryMoveOutLineForm'],
    frame: false,
    buttonAlign: 'left',
    autoScroll: true,
    fieldDefaults: {
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            if (form.isValid()) {
                ...
                var grid = Ext.getCmp('inventoryMoveOutLineGrid');
...
//InventoryMoveOutLineForm  Grid新建弹出窗口
Ext.define("InventoryMoveOutLineEditWindow", {
    extend: "Ext.Window",
    alias: ['widget.inventoryMoveOutLineEditWindow'],
    title: '添加物品',
    width: 480,
    height: 360,
    modal: true,
    ...
    layout: 'fit',
    items: [{
        xtype: 'inventoryMoveOutLineForm'
    }],
    listeners: {
        close: function () {
...
//InventoryMoveOutLine Grid表单
Ext.define("InventoryMoveOutLineGrid", {
    id: 'inventoryMoveOutLineGrid',
    extend: 'Ext.grid.Panel',
    alias: ['widget.inventoryMoveOutLineGrid'],
    columnLines: true,
    anchor: '100%',
    viewConfig: {
        border: false,
    ...
    multiSelect: true,
    newRecord: Ext.create('Module.pos.inventoryMoveOut.model.InventoryMoveOutLine', { SKU: '', Name: '', UOM: '', Quantity: 0, RealityQuantity: 0 }),
    editorWindow: Ext.create("InventoryMoveOutLineEditWindow", {}),
    bindingField: false,
    ...
    tbar: [{
        ...
        handler: function () {
            ...
            grid.newRecord = Ext.create('Module.pos.inventoryMoveOut.model.InventoryMoveOutLine', { SKU: '', Name: '', UOM: '', Quantity: 0, RealityQuantity: 0 });
    ...
    store: Ext.data.StoreManager.lookup('Module.pos.inventoryMoveOut.store.InventoryMoveOutLines'),
...
//InventoryMoveOutForm 创建InventoryMoveIn表单
Ext.define('InventoryMoveOutForm', {
    extend: 'Ext.form.Panel',
    id: 'form',
    alias: 'widget.inventoryMoveOutForm',
    hideLabel: true,
    fieldDefaults: {
        labelAlign: 'right',
        labelWidth: 140,
    ...
    items: [{
        ...
        items: [{
            ...
            items: [{
                title: '物品',
                items: [{
                    xtype: 'inventoryMoveOutLineGrid',
    ...
    buttons: [{
        ...
        handler: function () {
            ...
            if (form.isValid()) {
                form.submit({
                    url: Ext.String.format('{0}/InventoryMoveOuts', basket.dataSource),
                    method: 'POST',
...
//创建InventoryMoveOut弹出窗口
Ext.define('InventoryMoveOutWindow', {
    extend: 'Ext.Window',
    title: '创建',
    layout: 'fit',
    height: 400,
...
Ext.define('Module.pos.inventoryMoveOut.view.Main', {
    ...
    createItems: function() {
        ...
        formConfig.buttons = [
            ...
            },
            {
                ...
                text: 'Create',
                handler: function() {
                    var win = Ext.create('InventoryMoveOutWindow');
                    win.show();
                }
            }
        ];
    ...
    initComponent: function() {
        ...
        Ext.apply(me, {
            ...
            columns: [
                { text: '出库单号', dataIndex: 'IdNumber', width: 120 },
                {
                            ...
                            Ext.defer(function() {
                                ...
                                if (!button) {
                                    Ext.widget('button', {
                                        ...
                                        handler: function() {
                                            Ext.Ajax.request({
                                                url: Ext.String.format('{0}/InventoryMoveOuts({1})/CompleteInventory', basket.dataSource, r.get('Id')),
                                                method:'POST',
                            ...
                            Ext.defer(function() {
                                ...
                                if (!button) {
                                    Ext.widget('button', {
                                        ...
                                        handler: function () {
                                            Ext.Ajax.request({
                                                url: Ext.String.format('{0}/InventoryMoveOuts({1})/Closed', basket.dataSource, r.get('Id')),
                                                method: 'POST',
                            ...
                            Ext.defer(function () {
                                ...
                                if (!button) {
                                    Ext.widget('button', {
                                        ...
                                        handler: function () {
                                            Ext.Ajax.request({
                                                url: Ext.String.format('{0}/InventoryMoveOuts({1})/Cancel', basket.dataSource, r.get('Id')),
                                                method: 'POST',
                                                success: function (response) {
                                                    grid.getStore().load();
                                                }
