Ext.require([
    ...
    'Module.pos.customer.store.Customers',
    'Module.pos.customer.view.Main',
    'Module.pos.staff.store.Staffs',
    'Module.pos.staff.view.Main',
    'Module.pos.vehicleModel.view.Main',
    'Module.pos.vehicleModel.store.VehicleModels',
    'Module.pos.bay.store.Bays',
    'Module.pos.bay.view.Main',
    'Module.pos.productPrice.store.ProductPrices',
    'Module.pos.productPrice.view.Main'
]);

Ext.define('Module.pos.serviceInstance.view.CreateWindow', {
    extend: 'Ext.Window',
    alias: 'widget.serviceInstanceCreateWindow',
    height: 540,
    width: 800,
    constrain: true,
    modal: true,
    ...
    apiPath: Ext.String.format('{0}/api/ServiceInstancesApi', "/" === basket.contextPath ? "" : basket.contextPath),
    ...
    initComponent: function() {
                ...
                },
                {
                    items: [{
                            ...
                            windowConfig: {
                                height: 420,
                                width: 680,
                                searchPanelType: 'customerMainView'
                            },
                            itemSelected: function(window, innerGrid, record, item, index, e, eOpts) {
                                var me = this,
                            ...
                            windowConfig: {
                                height: 420,
                                width: 680,
                                searchPanelType: 'vehicleModelMainView'
                            },
                            itemSelected: function(window, innerGrid, record, item, index, e, eOpts) {
                                var me = this,
                            ...
                            windowConfig: {
                                height: 420,
                                width: 680,
                                searchPanelType: 'bayMainView'
                            },
                            itemSelected: function(window, innerGrid, record, item, index, e, eOpts) {
                                var me = this,
                                    code = record.get("BayNumber");
        ...
        var store = me.store = Ext.create('Module.pos.serviceInstance.store.InstanceProducts', {
            listeners: {
        ...
        var grid = me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                { text: '价格', dataIndex: 'Price', width: 150 }
            ],
            listeners: {
    ...
    refresh: function(data) {
        ...
        try {
            ...
            var record = Ext.create('Module.pos.serviceInstance.model.ServiceInstance', data);
            this.getForm().getForm().loadRecord(record);
            this.getStore().loadData(data.InstanceProducts);
